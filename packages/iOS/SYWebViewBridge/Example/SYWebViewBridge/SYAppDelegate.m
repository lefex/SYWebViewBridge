...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"application" message:@"applicationWillEnterForeground" delegate:nil cancelButtonTitle:@"cancel" otherButtonTitles:@"ok", nil];
    [alert show];
}

- (void)applicationDidBecomeActive:(UIApplication *)application
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"application" message:@"applicationDidBecomeActive" delegate:nil cancelButtonTitle:@"cancel" otherButtonTitles:@"ok", nil];
    [alert show];
